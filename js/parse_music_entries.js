	...
	$.getJSON('http://weeklymusicthread.com/music_entries.json', postData => {
		...
		postData.forEach (entry => {
			if (entry.post_page === postPage) { // this is how we filter per page!
				...
				$("#"+postId).append('<p><u> "'+entry.song+'" by '+ '<a href="file:///C:/Users/sampa/myDevProjects/weeklymusicthread.github.io/search.html?artist='+entry.artist+'">"'+entry.artist+'"</a>'+' </u></p>');
